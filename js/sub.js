...
const docent = () => {
  let $menu1 = get("#header .nav .gnb .menu1");
  let $subGnb = getAll("#header .nav .gnb li .subGnb");
  let $subMenu3 = get("#header .nav .gnb .menu1 .subGnb .subMenu3");
  // $menu1.classList.add("on");
  // $subGnb[0].classList.add("show");
  // $subMenu3.classList.add("on");
};

const news = () => {
  let $menu2 = get("#header .nav .gnb .menu2");
  let $subGnb = getAll("#header .nav .gnb li .subGnb");
  let $subMenu2 = get("#header .nav .gnb .menu2 .subGnb .subMenu2");
  // $menu2.classList.add("on");
  // $subGnb[1].classList.add("show");
